...
{
    public class CreateChartCountOfSellsCommand : BaseCommand
    {
        private readonly AnalyticsViewModel _analyticsViewModel;
        private readonly UserStore _userStore;
        private readonly ISellService _sellService;

        public CreateChartCountOfSellsCommand(UserStore userStore,
        ...
        public override void Execute(object parameter)
        {
            ...
            {
                chartViewModel.DataPoints.Add(new DataPoint(date, _sellService.GetCountOfSellsOnDate(date, _userStore.CurrentUser.Id)));
            }
